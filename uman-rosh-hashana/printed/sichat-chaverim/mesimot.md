...
1. בירור המדמה
2. ארץ ישראל
3. שלוחין ה' –הרב צנעני
4. תחיית המתים – עצמות יוסף. גדולים במיתתן, לא היה ולא יהיה.
5. להרחיב את עניין הגמרא.

# משימות נוספות

1. להוסיף את הששים גיבורים לר' אהרון.
2. להראות שכל מקום שכתוב גדולים צדיקים במיתתן מובא עניין ההשתטחות.
3. למצוא מקור לאתפשטותא דמשה בכל דרא ודרא
4. לבדוק את המקור הזה פרפראות לחכמה ס' אות יד

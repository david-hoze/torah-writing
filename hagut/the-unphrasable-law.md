...
וכאן נסגר המעגל עם הסעיף הקודם: המשפט השני הוא בדיוק הרישיון לחריגה. מי שמחזיק ספר ובוטח בו יודע דבר אחד שהספר לעולם לא יידע — שהספר אמין. החריגה אינה כישרון נדיר ואינה הברקה; היא תכונה מובנית של עצם המעמד שבו ספר מונח לפני מי שבוטח בו. תנו לי ספר ואמון — ואצביע על אמת שהספר מחמיץ.
...
_הסייג השני — האקראיות._ החריגה דורשת ספר שמדבר ברור: כדי לעמוד על ספר ולגבור עליו, צריך לדעת מה הוא אומר. חוק שמטיל מטבע חומק מן המנגנון: אי אפשר "לעשות את ההפך" ממה שמטבע יחזה. ואכן, קיימות מערכות תיאורטיות שמדגימות הכרה עצמית עקבית במחיר הסתברותי (נספח ה). אם חוקיותנו הסתברותית ביסודה, המחסום מתעדן: לא כל ידיעה עצמית נשללת, אלא רק ידיעה ודאית; הכרה עצמית הסתברותית נותרת פתוחה.
...
מילון ההתאמה ללשון הטקסט הראשי: "הספר אינו סותר את עצמו" — עקביות; "נבדק מכנית" — אקסיומטיזציה רקורסיבית; "יודע חשבון" — הכלת Q; "הכתם העיוור" — הפסוק G; "תעודת היושר" — Con(F); "אמון חלקי ומותנה" — התנאי של לב; "החריגה" של סעיפים ב–ד — המעבר מ־F בצירוף נאותותה אל Con(F).

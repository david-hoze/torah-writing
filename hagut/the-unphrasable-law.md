...
זה כל המאמר, במשפט אחד. השאר הוא פירוט: מדוע החריגה הזאת אינה משל אלא משפט מתמטי; מה בדיוק היא מוכיחה ומה לא; ומה קורה כשמנסים לברוח ממנה אל הקולקטיב — אל האנושות כולה, כגוף יודע אחד. ליחיד יש לפחות "בחוץ" — אנשים אחרים, מדע, מבט מן הצד. לאנושות אין בחוץ. ושם, אטען, הטיעון מקבל את צורתו החריפה ביותר.
...
וכאן נסגר המעגל עם הסעיף הקודם: מה שהמחשב המנבא חווה מול האדם שמפר את תחזיתו, גדל הוכיח על הלוח. מי שמחזיק ספר ובוטח בו עומד במקום שהספר אינו מגיע אליו: הוא רואה שהספר אמין, ורואה את מה שמתחייב מן האמינות הזאת ושהספר עצמו אינו מסוגל להסיק. החריגה אינה כישרון נדיר ואינה הברקה; היא תכונה מובנית של עצם המעמד שבו ספר מונח לפני מי שבוטח בו. תנו לי ספר ואמון — ואצביע על אמיתות שהספר מחמיץ.

כאן מתבקש חשד. הפסוק שגדל בנה הוא משפט שמדבר על עצמו — הנדסה לוגית שנועדה מראש לשבור את המערכת. אולי כל הכתם העיוור הוא כזה? פינה פתולוגית של משפטים מתחכמים, שאיש מלבד הלוגיקנים אינו גר בה, בעוד המתמטיקה האמיתית — המספרים, הסדרות, הצורות — שלמה ובריאה? החשד מובן, והוא הופרך. בשנת 1944 ניסח ראובן גודשטיין משפט פשוט על מספרים: קחו מספר, כתבו אותו בדרך מסוימת, הגדילו את הבסיס, החסירו אחת, וחזרו על התהליך. המשפט קובע שכל סדרה כזאת, גם אם היא מזנקת תחילה לגבהים דמיוניים, מגיעה בסופה לאפס. אין כאן שום התייחסות עצמית, שום פרדוקס, שום "אני" — חשבון, כמעט של בית ספר. המשפט אמיתי, והוכח בכלים חזקים. ובשנת 1982 הוכיחו קירבי ופריס שספר החוקים הסטנדרטי של האריתמטיקה אינו מסוגל להוכיח אותו. הפסוק של גדל היה בוחן הלחץ, שהונדס במיוחד כדי לחשוף את הגבול; משפט גודשטיין הוא מה שמתגלה משנחשף הגבול — שמעבר לו שוכנת גם מתמטיקה רגילה לגמרי. הכתם העיוור אינו פינה. גרות בו אמיתות חשבוניות מן השורה.
...
(הניסוחים המדויקים — שני המשפטים, שלושת התנאים, משפט לב ומשפט גודשטיין, וההתאמה בינם לבין לשון הספר והכתם — בנספח א.)
...
## ז. סייגים, כדי שלא נטען יותר מן המוכח
...
נספח זה מנסח במדויק את התוצאות שסעיף ג מציג במילים. "הספר" של הטקסט הראשי הוא המערכת הפורמלית F שלהלן.
...
מילון ההתאמה ללשון הטקסט הראשי: "הספר אינו סותר את עצמו" — עקביות; "נבדק מכנית" — אקסיומטיזציה רקורסיבית; "יודע חשבון" — הכלת Q; "הכתם העיוור" — הפסוק G; "תעודת היושר" — Con(F); "אמון חלקי ומותנה" — התנאי של לב; "החריגה" של סעיפים ב–ד — המעבר מ־F בצירוף נאותותה אל Con(F); "אמיתות חשבוניות מן השורה" בכתם — משפט גודשטיין ומשפחתו.
...
נספח זה מבסס את הסייג השני של סעיף ז.
